...
int Open_JTalk_load(Open_JTalk * open_jtalk, char *dn_mecab, char *dn_user = NULL);
int Open_JTalk_load_u16(Open_JTalk * open_jtalk, char16_t *dn_mecab, char16_t *dn_user = NULL);
